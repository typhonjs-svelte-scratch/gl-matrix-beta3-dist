...
import { GLM_EPSILON as GLM_EPSILON2 } from "gl-matrix/common";
var Mat2d = class _Mat2d extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b4 = b[4];
    const b5 = b[5];
    return Math.abs(a0 - b0) <= GLM_EPSILON2 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON2 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON2 * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= GLM_EPSILON2 * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= GLM_EPSILON2 * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= GLM_EPSILON2 * Math.max(1, Math.abs(a5), Math.abs(b5));
  }
  /**
...
import { GLM_EPSILON as GLM_EPSILON3 } from "gl-matrix/common";
var Mat3 = class _Mat3 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b7 = b[7];
    const b8 = b[8];
    return Math.abs(a0 - b0) <= GLM_EPSILON3 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON3 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON3 * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= GLM_EPSILON3 * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= GLM_EPSILON3 * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= GLM_EPSILON3 * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= GLM_EPSILON3 * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= GLM_EPSILON3 * Math.max(1, Math.abs(a7), Math.abs(b7)) && Math.abs(a8 - b8) <= GLM_EPSILON3 * Math.max(1, Math.abs(a8), Math.abs(b8));
  }
  /**
...
import { GLM_EPSILON as GLM_EPSILON4 } from "gl-matrix/common";
var Mat4 = class _Mat4 extends Float64Array {
  ...
  static lookAt(out, eye, center, up) {
    ...
    if (Math.abs(eyex - centerx) < GLM_EPSILON4 && Math.abs(eyey - centery) < GLM_EPSILON4 && Math.abs(eyez - centerz) < GLM_EPSILON4) {
  ...
  static equals(a, b) {
    ...
    const b14 = b[14];
    const b15 = b[15];
    return Math.abs(a0 - b0) <= GLM_EPSILON4 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON4 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON4 * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= GLM_EPSILON4 * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= GLM_EPSILON4 * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= GLM_EPSILON4 * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= GLM_EPSILON4 * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= GLM_EPSILON4 * Math.max(1, Math.abs(a7), Math.abs(b7)) && Math.abs(a8 - b8) <= GLM_EPSILON4 * Math.max(1, Math.abs(a8), Math.abs(b8)) && Math.abs(a9 - b9) <= GLM_EPSILON4 * Math.max(1, Math.abs(a9), Math.abs(b9)) && Math.abs(a10 - b10) <= GLM_EPSILON4 * Math.max(1, Math.abs(a10), Math.abs(b10)) && Math.abs(a11 - b11) <= GLM_EPSILON4 * Math.max(1, Math.abs(a11), Math.abs(b11)) && Math.abs(a12 - b12) <= GLM_EPSILON4 * Math.max(1, Math.abs(a12), Math.abs(b12)) && Math.abs(a13 - b13) <= GLM_EPSILON4 * Math.max(1, Math.abs(a13), Math.abs(b13)) && Math.abs(a14 - b14) <= GLM_EPSILON4 * Math.max(1, Math.abs(a14), Math.abs(b14)) && Math.abs(a15 - b15) <= GLM_EPSILON4 * Math.max(1, Math.abs(a15), Math.abs(b15));
  }
  /**
...
import { GLM_EPSILON as GLM_EPSILON5 } from "gl-matrix/common";
var Vec3 = class _Vec3 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b1 = b[1];
    const b2 = b[2];
    return Math.abs(a0 - b0) <= GLM_EPSILON5 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON5 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON5 * Math.max(1, Math.abs(a2), Math.abs(b2));
  }
};
...
import { GLM_EPSILON as GLM_EPSILON6 } from "gl-matrix/common";
var Vec4 = class _Vec4 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b2 = b[2];
    const b3 = b[3];
    return Math.abs(a0 - b0) <= GLM_EPSILON6 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON6 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON6 * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= GLM_EPSILON6 * Math.max(1, Math.abs(a3), Math.abs(b3));
  }
};
...
import { GLM_EPSILON as GLM_EPSILON7 } from "gl-matrix/common";
...
import { GLM_EPSILON as GLM_EPSILON8 } from "gl-matrix/common";
var Quat2 = class _Quat2 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b6 = b[6];
    const b7 = b[7];
    return Math.abs(a0 - b0) <= GLM_EPSILON8 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON8 * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= GLM_EPSILON8 * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= GLM_EPSILON8 * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= GLM_EPSILON8 * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= GLM_EPSILON8 * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= GLM_EPSILON8 * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= GLM_EPSILON8 * Math.max(1, Math.abs(a7), Math.abs(b7));
  }
};
Quat2.dot = Quat.dot;
...
import { GLM_EPSILON as GLM_EPSILON9 } from "gl-matrix/common";
var Vec2 = class _Vec2 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b0 = b[0];
    const b1 = b[1];
    return Math.abs(a0 - b0) <= GLM_EPSILON9 * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= GLM_EPSILON9 * Math.max(1, Math.abs(a1), Math.abs(b1));
  }
  /**
   * Returns a string representation of a vector
   * @category Static
