...
// dist/_lib/f64/Mat2.js
var import_common = require("gl-matrix/common");
var Mat2 = class _Mat2 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b2 = b[2];
    const b3 = b[3];
    return Math.abs(a0 - b0) <= import_common.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3));
  }
  /**
...
// dist/_lib/f64/Mat2d.js
var import_common2 = require("gl-matrix/common");
var Mat2d = class _Mat2d extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b4 = b[4];
    const b5 = b[5];
    return Math.abs(a0 - b0) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= import_common2.GLM_EPSILON * Math.max(1, Math.abs(a5), Math.abs(b5));
  }
  /**
...
// dist/_lib/f64/Mat3.js
var import_common3 = require("gl-matrix/common");
var Mat3 = class _Mat3 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b7 = b[7];
    const b8 = b[8];
    return Math.abs(a0 - b0) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a7), Math.abs(b7)) && Math.abs(a8 - b8) <= import_common3.GLM_EPSILON * Math.max(1, Math.abs(a8), Math.abs(b8));
  }
  /**
...
// dist/_lib/f64/Mat4.js
var import_common4 = require("gl-matrix/common");
var Mat4 = class _Mat4 extends Float64Array {
  ...
  static rotate(out, a, rad, axis) {
    ...
    if (len < import_common4.GLM_EPSILON) {
      return null;
    }
    len = 1 / len;
    x *= len;
  ...
  static lookAt(out, eye, center, up) {
    ...
    if (Math.abs(eyex - centerx) < import_common4.GLM_EPSILON && Math.abs(eyey - centery) < import_common4.GLM_EPSILON && Math.abs(eyez - centerz) < import_common4.GLM_EPSILON) {
  ...
  static equals(a, b) {
    ...
    const b14 = b[14];
    const b15 = b[15];
    return Math.abs(a0 - b0) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a7), Math.abs(b7)) && Math.abs(a8 - b8) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a8), Math.abs(b8)) && Math.abs(a9 - b9) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a9), Math.abs(b9)) && Math.abs(a10 - b10) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a10), Math.abs(b10)) && Math.abs(a11 - b11) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a11), Math.abs(b11)) && Math.abs(a12 - b12) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a12), Math.abs(b12)) && Math.abs(a13 - b13) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a13), Math.abs(b13)) && Math.abs(a14 - b14) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a14), Math.abs(b14)) && Math.abs(a15 - b15) <= import_common4.GLM_EPSILON * Math.max(1, Math.abs(a15), Math.abs(b15));
  }
  /**
...
// dist/_lib/f64/Vec3.js
var import_common5 = require("gl-matrix/common");
var Vec3 = class _Vec3 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b1 = b[1];
    const b2 = b[2];
    return Math.abs(a0 - b0) <= import_common5.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common5.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common5.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2));
  }
};
...
// dist/_lib/f64/Vec4.js
var import_common6 = require("gl-matrix/common");
var Vec4 = class _Vec4 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b2 = b[2];
    const b3 = b[3];
    return Math.abs(a0 - b0) <= import_common6.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common6.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common6.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common6.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3));
  }
};
...
// dist/_lib/f64/Quat.js
var import_common7 = require("gl-matrix/common");
var Quat = class _Quat extends Float64Array {
  ...
  static getAxisAngle(out_axis, q) {
    ...
    if (s > import_common7.GLM_EPSILON) {
      out_axis[0] = q[0] / s;
      out_axis[1] = q[1] / s;
      out_axis[2] = q[2] / s;
    } else {
  ...
  static slerp(out, a, b, t) {
    ...
    if (1 - cosom > import_common7.GLM_EPSILON) {
...
// dist/_lib/f64/Quat2.js
var import_common8 = require("gl-matrix/common");
var Quat2 = class _Quat2 extends Float64Array {
  ...
  static rotateAroundAxis(out, a, axis, rad) {
    if (Math.abs(rad) < import_common8.GLM_EPSILON) {
  ...
  static equals(a, b) {
    ...
    const b6 = b[6];
    const b7 = b[7];
    return Math.abs(a0 - b0) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1)) && Math.abs(a2 - b2) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a2), Math.abs(b2)) && Math.abs(a3 - b3) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a3), Math.abs(b3)) && Math.abs(a4 - b4) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a4), Math.abs(b4)) && Math.abs(a5 - b5) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a5), Math.abs(b5)) && Math.abs(a6 - b6) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a6), Math.abs(b6)) && Math.abs(a7 - b7) <= import_common8.GLM_EPSILON * Math.max(1, Math.abs(a7), Math.abs(b7));
  }
};
Quat2.dot = Quat.dot;
...
// dist/_lib/f64/Vec2.js
var import_common9 = require("gl-matrix/common");
var Vec2 = class _Vec2 extends Float64Array {
  ...
  static equals(a, b) {
    ...
    const b0 = b[0];
    const b1 = b[1];
    return Math.abs(a0 - b0) <= import_common9.GLM_EPSILON * Math.max(1, Math.abs(a0), Math.abs(b0)) && Math.abs(a1 - b1) <= import_common9.GLM_EPSILON * Math.max(1, Math.abs(a1), Math.abs(b1));
  }
  /**
   * Returns a string representation of a vector
   * @category Static
