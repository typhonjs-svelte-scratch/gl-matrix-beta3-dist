...
// dist/swizzle/f64/index.js
var f64_exports = {};
__export(f64_exports, {
  EnableSwizzlesF64: () => EnableSwizzlesF64
});
module.exports = __toCommonJS(f64_exports);
var import_f64 = require("gl-matrix/f64");
...
function EnableSwizzlesF64() {
  ...
  function getSwizzleImpl(swizzle) {
    switch (swizzle.length) {
      case 2:
        return function() {
          return new import_f64.Vec2(this[SWIZZLE_INDEX[swizzle[0]]], this[SWIZZLE_INDEX[swizzle[1]]]);
        };
      case 3:
        return function() {
          return new import_f64.Vec3(this[SWIZZLE_INDEX[swizzle[0]]], this[SWIZZLE_INDEX[swizzle[1]]], this[SWIZZLE_INDEX[swizzle[2]]]);
        };
      case 4:
        return function() {
          return new import_f64.Vec4(this[SWIZZLE_INDEX[swizzle[0]]], this[SWIZZLE_INDEX[swizzle[1]]], this[SWIZZLE_INDEX[swizzle[2]]], this[SWIZZLE_INDEX[swizzle[3]]]);
        };
    }
  }
  for (const swizzle of VEC2_SWIZZLES) {
    const impl = getSwizzleImpl(swizzle);
    Object.defineProperty(import_f64.Vec2.prototype, swizzle, {
      get: impl
    });
    Object.defineProperty(import_f64.Vec3.prototype, swizzle, {
      get: impl
    });
    Object.defineProperty(import_f64.Vec4.prototype, swizzle, {
      get: impl
    });
  }
